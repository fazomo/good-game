...
Precision audit agent powered by Codex. Invokes the Codex model via the codex CLI to cross-validate the same target from a different perspective than the Opus Auditor.
...
- Example: `codex.01.md`, `codex.02.md`
